...
<html lang="en">
	...
	<div class="page-content">
		...
		<p class="my-3">
		    <strong>
			<a target="_blank" href="https://caltechlibrary.github.io/dibs/">Caltech DIBS</a>
		    </strong>
		    (<em><strong>Di</strong>gital <strong>B</strong>orrowing <strong>S</strong>ystem</em>) is an implementation of <a target="_blank" href="https://controlleddigitallending.org">Controlled Digital Lending</a>, allowing library patrons to borrow materials that are not otherwise available in e-book or other electronic formats.

		    <center>
			<p><img src="{{base_url}}/static/megaphone.svg" class="svg-megaphone"> Send feedback by email to <a href="mailto:reserves@lib.uchicago.edu">reserves@lib.uchicago.edu</a>.</p>
		    </center>
